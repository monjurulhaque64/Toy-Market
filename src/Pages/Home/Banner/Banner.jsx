...
const Banner = () => {
    return (
        <div>
            <div className="banner bg-cover bg-center h-64 md:h-80 lg:h-96 rounded-lg" style={{ backgroundImage: 'url(https://thumbs.dreamstime.com/b/baby-kids-toys-banner-background-teddy-bear-plastic-construction-plane-wooden-blocks-light-blue-color-background-baby-kids-toys-223545231.jpg)' }}>
